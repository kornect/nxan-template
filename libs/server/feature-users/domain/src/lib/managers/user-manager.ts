...
import { Result } from '@nxan/server/core/dtos';
import { HashService } from '@nxan/server/core/hash';
import { OtpService } from '@nxan/server/core/otp';
...
export class UserManager {
  constructor(private entityManager: EntityManager, private hashService: HashService, private otpService: OtpService) {}

...
export class UsersApi extends BaseService {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  registerConfirm$Response(params: {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  registerResend$Response(params: {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  registerCancel$Response(params: {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  confirmEmailChange$Response(params: {
    id: string;
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  changeDisplayName$Response(params: {
    id: string;
